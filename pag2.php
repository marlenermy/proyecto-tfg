...
<body>
<form CLASS="borde" action="pag2.php" method="post" style="background-color:#add8e6">
...
if ($nfilas > 0)
{
    ...
    print ("<tr>\n");
    print ("<th width='100' class='confondo'>CodProducto</th>\n");
    print ("<th width='100' class='confondo'>Nombre</th>\n");
    print ("<th width='100' class='confondo'>Tipo</th>\n");
    print ("<th width='100' class='confondo'>Precio</th>\n");
    print ("</tr>\n");
    print ("</table>\n");
